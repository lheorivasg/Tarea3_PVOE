...
public class FrmVacaciones extends javax.swing.JFrame {
    ...
    private void llenarBotonesMedioTransporte() {
        ...
        mediosTransporte.add(new MedioTransporte("Autobus", "BUS"));
        mediosTransporte.add(new MedioTransporte("Avión", "AVION"));
        mediosTransporte.add(new MedioTransporte("Auto propio", "AUTO"));
        mediosTransporte.add(new MedioTransporte("Auto rentado", "AUTO_R"));
        
        btnAutobus.setText(mediosTransporte.get(0).getNombre());
        btnAvion.setText(mediosTransporte.get(1).getNombre());
        btnAutoPropio.setText(mediosTransporte.get(2).getNombre());
